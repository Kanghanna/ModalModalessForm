...
namespace ModalModalessForm
{
    public partial class FormMain : Form
    {
        ...
        private void ShowModal()
        {
            ...
            FormModal m = new FormModal(); //객체 생성
            m.Title = "모달 창띄우기"; //modal 창의 제목
            m.ShowDialog();
        }
        ...
        private void ShowModaless()
        {
            ...
            FormModaless m = new FormModaless(); //객체 생성
            m.Title = "모달리스 창띄우기"; //modal 창의 제목
            m.Show();
        }
        ...
        private void 이프로그램은ModalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FormAbout m = new FormAbout(); //객체 생성
            m.Title = "이 프로그램은..(Modal) 띄우기"; //modal 창의 제목
            m.ShowDialog();
        }
        ...
        private void 이프로그램은ModalessToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FormAbout m = new FormAbout(); //객체 생성
            m.Title = "이 프로그램은..(Modaless) 띄우기"; //modal 창의 제목
            m.ShowDialog();
        }
    }
}
